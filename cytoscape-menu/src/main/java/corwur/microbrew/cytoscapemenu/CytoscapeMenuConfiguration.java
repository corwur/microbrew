...
public class CytoscapeMenuConfiguration implements ServerConfiguration, Neo4jConfiguration {

    private final ApplicationConfiguration configuration;

    public CytoscapeMenuConfiguration(ApplicationConfiguration configuration) {
